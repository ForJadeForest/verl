...
EXPERIMENT_NAME="Qwen2.5-VL-7B-MMCrop-MMMath-Ground-R1"
...
DATASET_TRAIN=${GROUND_R1_TRAIN_DATASET_DIR}
...
REF_MODEL_PATH=/root/models/Qwen2.5-VL-7B-MMCrop-MMMath-1epoch-1e-5lr
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.log_reward_keys=['acc_reward','format_reward','acc','code_error_reward','ground_reward'] \
    ...
    +trainer.resume_from_path="/apdcephfs_gy5/share_303588738/yingzhepeng/results/verl_checkpoints/CodeAgent/Qwen2.5-VL-7B-MMCrop-MMMath-Ground-R1/20250830_183617/global_step_28" \
