...
EXPERIMENT_NAME="Qwen2.5-VL-7B-MMCrop-MMMath-TreeRL"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +trainer.resume_from_path="/apdcephfs_gy5/share_303588738/yingzhepeng/results/verl_checkpoints/CodeAgent/Qwen2.5-VL-7B-MMCrop-MMMath-TreeRL/20250830_103008/global_step_4" \
