...
EXPERIMENT_NAME="Qwen2.5-VL-7B-MMCrop-TreeRL-MoreTurns"
...
DATASET_VAL=${VAL_DATASET_DIR}/lmm_eval_lite_perception_1k.parquet
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=25340 \
    ...
    +actor_rollout_ref.rollout.multi_turn.single_max_new_tokens=2048 \
    ...
    +reward_model.log_reward_keys=['acc_reward','format_reward','acc','code_error_reward','ground_reward','ground_recall_reward','ground_precision_reward','code_repetition_reward'] \
    ...
    +trainer.resume_from_path="/apdcephfs_gy5/share_303588738/yingzhepeng/results/verl_checkpoints/CodeAgent/Qwen2.5-VL-7B-MMCrop-TreeRL-MoreTurns/20250831_213534/global_step_8" \
