...
EXPERIMENT_NAME="Qwen2.5-VL-7B-CropMath-Thyme-NoCode-Maze-ThymeCode-AgentLoop-DEBUG"
...
# REF_MODEL_PATH=/root/models/Qwen2.5-VL-7B-1w-v3_code_check_1epoch_tool_desc_v2

PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    --config-path=/mnt/private_yingzhepeng/code/rl/verl/recipe/code_agent/configs \
    --config-name='code_vlm_multiturn_grpo' \
    data.train_files=${DEEPEYES_TRAIN_DATASET_DIR} \
